...
export default function Favourites() {
  ...
  const settingOptionState = async () => {
    if(isLoggedIn){
      ...
      {
        data.preferences.SelectedSport.length !== 0 ? setOptionFevSport(data.preferences.SelectedSport) : ""
        data.preferences.SelectedTeams.length !== 0 ? setOptionFevTeam(data.preferences.SelectedTeams)
