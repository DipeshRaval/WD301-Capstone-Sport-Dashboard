    ...
    <div className="mt-4 relative">
      ...
      <div className="w-10/12">
        <div className="flex justify-between">
          <div className="flex text-gray-800 p-3 overflow-x-auto ">
            <p onClick={()=>{ setFilter("") }}  className="text-center px-10 py-2 border-gray-800 border-b-4 border-grey-900 font-bold bg-gray-100 rounded">
              All news
            </p>
            {sports.map((sport : Sport)=>(
              <p className="px-10 py-2 text-center" onClick={chnageFilter}>{ sport.name }</p>
            ))}
          </div>
