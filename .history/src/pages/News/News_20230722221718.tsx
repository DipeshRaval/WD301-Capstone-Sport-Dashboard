            ...
            <div className="border rounded-md flex items-center">
              <div className="px-4">
                ...
                <p className="text-gray-900">
                  ...
                  Corporis ipsum non expedita perferendis aliquam quis?
                  Obcaecati beatae doloremque possimus provident! Ut recusandae
                  expedita accusantium, aperiam odit odio possimus, ab illum
